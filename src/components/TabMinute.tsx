...
const minuteOptions = generateRange(0, 59, padZero)
 ...
 * mode 与生成值的对应关系：
 *   1 → *           每分钟
 *   2 → start-end   周期，如 10-30
 *   3 → start/step  间隔，如 0/15（从第0分起每15分钟）
 *   4 → 1,15,30     指定具体分钟值；全选60个时合并为 *
 */
export const TabMinute: React.FC<TabPanelProps> = ({ value, onChange }) => {
